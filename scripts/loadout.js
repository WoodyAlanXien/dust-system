Hooks.on("renderActorSheet", (app, html, data) => {
    ...
    html.find("#weapon1").on("change", (event) => actor.update({ "system.attributes.loadout.weapon1": event.target.value }));
    html.find("#weapon2").on("change", (event) => actor.update({ "system.attributes.loadout.weapon2": event.target.value }));
    html.find("#armor").on("change", (event) => actor.update({ "system.attributes.loadout.armor": event.target.value }));
