...
Hooks.on("preUpdateActor", (actor, updateData, options, userId) => {
  ...
  const relentlessResilience = system.attributes.relentless.attributes.nerveMax/3;
  const elusiveResilience = system.attributes.elusive.attributes.nerveMax/3;
  const charmingResilience = system.attributes.charming.attributes.nerveMax/3;
  const discreetResilience = system.attributes.discreet.attributes.nerveMax/3;
  

  const totalResilience = relentlessResilience + elusiveResilience + charmingResilience + discreetResilience;
